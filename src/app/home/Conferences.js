                ...
                {conferences.map((conference, index) => (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className={`timeline-end w-full max-w-[480px] -mb-[180px] lg:-mb-[60px] bg-[#F9FAFB] border-t-4 border-ctLightGray rounded-lg py-7 px-4 shadow-md flex gap-3 ${index % 2 === 0 ? "lg:timeline-start" : "lg:timeline-end"
                        }`}
                    >
                      <svg
                        className="mt-2"
                    ...
                    <div
                      className={`timeline-end caption-text text-ctDeepGray ${index % 2 === 0 ? "lg:timeline-end" : "lg:timeline-start"
                        }`}
                    >
                    ...
                    {index === conferences.length - 1 ? (
                      ...
                      <hr
                        className={`!w-[3px] !h-[300%] ${index === 0 ? "bg-ctYellow" : "bg-ctLightGray"
                          }`}
                      />
                    )}
                  </li>
